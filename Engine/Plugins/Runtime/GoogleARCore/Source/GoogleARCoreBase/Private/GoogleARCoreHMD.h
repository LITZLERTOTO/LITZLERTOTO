 ...
 */
class FGoogleARCoreHMD : public IHeadMountedDisplay, public ISceneViewExtension, public TSharedFromThis<FGoogleARCoreHMD, ESPMode::ThreadSafe>
{
public:
