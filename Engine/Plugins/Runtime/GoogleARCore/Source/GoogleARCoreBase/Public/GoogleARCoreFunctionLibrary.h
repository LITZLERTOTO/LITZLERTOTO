...
public:
	...
	static void GetCurrentSessionConfig(FGoogleARCoreSessionConfig& OutARCoreConfig);
	...
	static EGoogleARCoreSessionStatus GetARCoreSessionStatus();
	...
	static void StartSessionWithConfig(UObject* WorldContextObject, struct FLatentActionInfo LatentInfo, const FGoogleARCoreSessionConfig& Configuration);
	...
	*/
	...
	static void RemoveGoogleARAnchorObject(UGoogleARCoreAnchor* ARAnchorObject);
